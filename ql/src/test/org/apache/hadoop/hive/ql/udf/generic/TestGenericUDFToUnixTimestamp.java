...
public class TestGenericUDFToUnixTimestamp extends TestCase {
  ...
  public void testStringArg2() throws HiveException {
    ...
    runAndVerify(udf2,
        ...
        new LongWritable(TimestampTZUtil.parse("1400-01-31 09:00:32", ZoneId.systemDefault()).getEpochSecond()));
    runAndVerify(udf2,
        new Text("1400-02-01 00:00:00 UTC"),
        new Text("yyyy-MM-dd HH:mm:ss z"),
        new LongWritable(TimestampTZUtil.parse("1400-01-31 16:07:01", ZoneId.systemDefault()).getEpochSecond()));
    runAndVerify(udf2,
