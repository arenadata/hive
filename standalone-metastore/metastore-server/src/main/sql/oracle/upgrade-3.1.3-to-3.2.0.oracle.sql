SELECT 'Upgrading MetaStore schema from 3.1.3 to 3.2.0' AS Status from dual;
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3 to 3.2.0' AS Status from dual;
